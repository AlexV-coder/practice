...
public class _Predicate {
    public static void main(String[] args) {
        ...
        System.out.println(isPhoneNumberValidPredicate.and(containsNumber3).test("07300000000"));
        System.out.println(isPhoneNumberValidPredicate.or(containsNumber3).test("03000000000"));
    }
